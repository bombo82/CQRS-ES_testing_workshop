...
{
    public class CreateDailyProgramming_ReserveSeats_Exception : CommandSpecification<ReserveSeats>
    {
        ...
        public CreateDailyProgramming_ReserveSeats_Exception()
        {
            ExpectedException = new Exception("booom");
