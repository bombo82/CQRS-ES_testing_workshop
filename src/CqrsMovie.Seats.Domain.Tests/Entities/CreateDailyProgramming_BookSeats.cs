...
{
    public class CreateDailyProgramming_BookSeats : CommandSpecification<BookSeat>
    {
        ...
        public CreateDailyProgramming_BookSeats()
        {
        ...
        protected override BookSeat When()
        {
            return new ReserveSeats(aggregateId, seats);
        }

        protected override ICommandHandler<BookSeat> OnHandler()
        {
